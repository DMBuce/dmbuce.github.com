...
"Dragonborn,Mariner,Knife (as dagger),Rope (20')",
"Dragonborn,Sailor,Shortsword,Monkey",
"Dragonborn,Sailor,Shortsword,Parrot",
...
"Minotaur,Farmer,Pitchfork (as spear),Hen",
"Minotaur,Farmer,Pitchfork (as spear),Hen",
"Minotaur,Farmer,Pitchfork (as spear),Goat",
"Minotaur,Farmhand,Sickle,Seeds",
"Minotaur,Farmhand,Sickle,Seeds",
"Minotaur,Farmhand,Sickle,Sheep",
...
function genCharacter() {
	...
	retval += "Abilities: Str __, Dex __, Con __, Int __, Wis __, Cha __\n";
	//con = (abilities[2] - 10) // 2 + "\n";
	//retval += "HP: %s (1d4+%s, rolled %s)" % ( max(1, hproll+con), con, hproll ) + "\n";
	//retval += "HP: %s (1d4, rolled %s)" % ( max(1, hproll), hproll ) + "\n";
	retval += "HP: " + Math.max(1, hproll) + " (1d4, rolled " + hproll + ")\n";
